...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="/1r Sprint-FMSDigital/Maquetacion/Estudiante/clase_de_alumno.css">
</head>
<body>
  ...
  <nav>
    ...
    <div class="main">
      ...
      <section class="section" id="tablero">
        ...
        <form action="/1r Sprint-FMSDigital/Maquetacion/Estudiante/C_comentario.php" method="POST">
