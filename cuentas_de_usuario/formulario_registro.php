...
<head>
    ...
    <link rel="stylesheet" href="/1r Sprint-FMSDigital/Maquetacion/cuentas_de_usuario/formulario_registro.css">
...
<body>
  ...
  <div class="container">
    <h1>REGISTRO</h1>
    <form action="/1r Sprint-FMSDigital/Maquetacion/cuentas_de_usuario/datosR.php" method="post" id="registro">
    ...
    <a href="formulario_login.php" class="boton">Login</a>
  </div>
