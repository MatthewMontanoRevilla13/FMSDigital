...
<head>
  ...
  <link rel="stylesheet" href="/1r Sprint-FMSDigital/Maquetacion/CuentasDeUsuario/FormularioLogin.css">
...
<body>
  ...
  <div class="container">
    ...
    <form action="/1r Sprint-FMSDigital/Maquetacion/CuentasDeUsuario/datosL.php" method="post" id="login">
