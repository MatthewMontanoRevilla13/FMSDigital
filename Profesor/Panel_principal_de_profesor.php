...
<head>
  ...
  <link rel="stylesheet" href="/1r Sprint-FMSDigital/Maquetacion/Profesor/Panel_principal_de_profesor.css">
  <link rel="stylesheet" href="/1r Sprint-FMSDigital/Maquetacion/Profesor/formulario_Crear_Clase.css">
...
<body>
  ...
  <div class="menu-secundario">
    <a href="#">Calendario</a>
    <a href="/1r Sprint-FMSDigital/Maquetacion/Profesor/formulario_editar_clase.php">Editar cursos</a>
  ...
  <div class="contenedor-clases">
    ...
    if (mysqli_num_rows($resultado) > 0) {
        while ($fila = mysqli_fetch_assoc($resultado)) {
            echo "<div class='clase' onclick=\"window.location.href='clase_de_profesor.php?id_clase=" . $fila['id_clase'] . "'\" style='cursor:pointer;'>";
  ...
  <div id="formularioCrearClase" style="display:none; padding: 20px; border: 2px solid #ccc; margin: 20px; background-color: #f9f9f9;">
    <h2>CREA TU CLASE</h2>
    <form action="/1r Sprint-FMSDigital/Maquetacion/Profesor/datos crear clase.php" method="post" id="CrearClase">
